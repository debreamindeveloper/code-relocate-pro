    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="sm" className="gap-2">
          <img src={currentLanguage.flag} alt={currentLanguage.name} className="w-5 h-4 object-cover" />
      ...
      <DropdownMenuContent align="end">
        {languages.map((language) => (
          <DropdownMenuItem
            ...
            className="gap-2"
          >
            <img src={language.flag} alt={language.name} className="w-5 h-4 object-cover" />
            {language.name}
          </DropdownMenuItem>
        ))}
      </DropdownMenuContent>
